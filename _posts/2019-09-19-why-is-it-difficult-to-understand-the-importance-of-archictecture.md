...
돌아가는 행위(외부 품질)만 중시하고, 설계(내부 품질)를 등한시하면 유지 보수 비용이 결국에는 증가할 거라는 믿음은 기술 부채라는 메타포가 되었다. 내 주변의 개발자 중에서 이를 모르는 사람은 거의 없다. 

Clean Archictecture의 저자, 로버트 마틴은 설계(Archictecture)의 중요성을 설득하는 책임은 개발팀에게 있다고 말한다. 로버트 마인에게는 이게 장인 정신이다. 문제를 잘 아는 사람이, 문제를 덜 아는 사람을 설득해야 한다는 점에서 공감한다.
...
물론 말은 쉽다. 세상의 많은 일은 몰라서 못하는 게 아니다. 나 역시도 네이버에서 일을 하면서 이 투쟁을 완성하지 못했으니까. 그럼에도 조금씩, 조금씩 두들기다 보면 언젠가는 저 벽을 허물 수 있지 않을까. 어쩌면 내 성장이 거기에 있을지도 모르겠다.
